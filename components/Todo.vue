        ...
        <div class="bg-white rounded shadow p-6 m-4 w-full lg:w-3/4 lg:max-w-lg">
          <div class="mb-4">
            ...
            <div class="flex mt-4">
              ...
              <input class="shadow appearance-none border rounded w-full py-2 px-3 mr-4 text-grey-darker" placeholder="Add Todo" v-model="content" @keyup.enter="submit">
  ...
  methods:{
    ...
    deleteTodo:function(todo,i){
      ...
      this.$axios.delete(api).then(res=>{
        const deleteComplete = 1;
        if(res.data === deleteComplete){
